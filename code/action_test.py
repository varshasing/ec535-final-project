...
# LOCK variable: used for making sure that WASD doesn't interfere
action_lock = False
HomePath = '/home/pi'
...
def online_thread_run_acting():
    global online_action_times, online_action_num, update_ok, action_group_finish, action_lock
    while True:
        if update_ok:
...
def change_action_value(actNum, actTimes):
    global online_action_times, online_action_num, update_ok, stopRunning, action_group_finish, action_lock
    #    print(f"action '{actNum}' is already running. Please wait.")
    #    return
